# EXERCISE 5
# Write some code to create a deep copy of the dict1 object and assign it to dict2. You should 
# only modify the code where indicated.
...
dict2 = deepcopy(dict1) # You may modify the `???` part
            # of this line
