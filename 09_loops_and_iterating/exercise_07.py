...
my_tuple = (1, 'a', '1', 3, [7], 3.1415,
            -4, None, {1, 2, 3}, False)
# You can use the expression type(object) is int to determine whether an object is an integer. For
# instance:
...
# You may receive a SyntaxWarning warning message from the last two examples. You can ignore that 
# warning.
